...
Für detaillierte Installationsanweisungen siehe [INSTALLATION.de.md](INSTALLATION.de.md) ([English](INSTALLATION.md)).
...
```
notion-ai-papers/
├── SKILL.md                      # Haupt-Skill-Definition (Deutsch)
...
├── INSTALLATION.md               # Installationsanleitung (Englisch)
├── INSTALLATION.de.md            # Installationsanleitung (Deutsch)
├── CHANGELOG.md                  # Änderungsprotokoll (Englisch)
...
* **Metadaten**: Authors, Publication, PDF\_Link
...
Siehe [CONTRIBUTING.de.md](CONTRIBUTING.de.md) ([English](CONTRIBUTING.md)) für Details.
...
[LinkedIn](https://www.linkedin.com/in/hayaloezkan/) • [Documentation](docs/) • [Contributing](CONTRIBUTING.de.md)
